...
public class MaxTempMapComParRed {
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(MaxTempMapComParRed.class);
		job.setJobName("Max temperature");
		job.setNumReduceTasks(12);
		// edit the previous line for number of reducers
		job.setMapperClass(TemperatureMapper1.class);
		job.setCombinerClass(TemperatureReducer1.class);
		job.setPartitionerClass(TemperaturePartitioner1.class);
		job.setReducerClass(TemperatureReducer1.class);
...
class TemperatureMapper1 extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	@Override
...
class TemperaturePartitioner1<K2, V2> extends Partitioner<Text, DoubleWritable> {
...
class TemperatureReducer1 extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
	@Override
